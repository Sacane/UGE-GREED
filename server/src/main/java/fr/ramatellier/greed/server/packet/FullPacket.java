...
public sealed interface FullPacket extends Packet permits AddNodePacket, ConnectKOPacket, ConnectOKPacket, ConnectPacket, LogoutGrantedPacket, LogoutRequestPacket, WorkAssignmentPacket, WorkRequestPacket, WorkRequestResponse, WorkResponsePacket {
