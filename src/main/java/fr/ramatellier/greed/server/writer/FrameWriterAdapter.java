...
import fr.ramatellier.greed.server.model.component.GreedComponent;
...
public class FrameWriterAdapter {
    ...
    public static <T extends Frame> int size(T recordPacket) throws InvocationTargetException, IllegalAccessException {
        ...
        adapt(recordPacket, b -> sizes[1] = Byte.BYTES, i -> sizes[2] = Integer.BYTES, l -> sizes[3] = Long.BYTES, packet -> sizes[4] = packet.size());
